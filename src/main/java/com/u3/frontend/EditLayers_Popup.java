    ...
    private void initComponents() {
        ...
        if ( layersList != null ) {
            for (String layer : layersList) {
                ...
                } else if (layer.equals("User Created POIs")) {
                ...
                } else if (layer.equals("Collaborative Spaces")) {
                    CSpaces_CheckBox.setSelected(true);
                } else if (layer.equals("Favourite POIs")) {
    ...
    public void POILayer_ButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (evt.getSource() == Entry_Points_CheckBox) {
            ...
            if (CSpaces_CheckBox.isSelected()) {
                this.Poi.addLayer("Collaborative Spaces");
            } else {
                this.Poi.removeLayer("Collaborative Spaces");
            }
            ...
            if (FavPOI_CheckBox.isSelected()) {
                this.Poi.addLayer("Favourite POIs");
            } else {
                this.Poi.removeLayer("Favourite POIs");
            }


        } else if (evt.getSource() == UCPOI_CheckBox) {
            if (UCPOI_CheckBox.isSelected()) {
                this.Poi.addLayer("User Created POIs");
            } else {
                this.Poi.removeLayer("User Created POIs");
            }
