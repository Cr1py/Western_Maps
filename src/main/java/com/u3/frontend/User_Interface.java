...
public class User_Interface extends javax.swing.JFrame {
        ...
        for (String layerName : selectedLayers) {
            switch (layerName) {
                ...
                case "Elevators":
                    ...
                    break;
                case "User Created POIs":
                    ArrayList<Poi> poisUserCreated = floormap.getPoiLayer("User Created POIs");
                ...
                case "Labs":
                    ...
                    break;
                case "Collaborative Spaces":
                    ArrayList<Poi> poisCollab = floormap.getPoiLayer("Collaborative Spaces");
    ...
    public void Layer_ButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (evt.getSource() == Entry_Points_CheckBox) {
            ...
            updateSelectedLayers("Collaborative Spaces", CSpaces_CheckBox.isSelected());
            ...
            updateSelectedLayers("Favourite POIs", FavPOI_CheckBox.isSelected());
        } else if (evt.getSource() == UCPOI_CheckBox) {
            updateSelectedLayers("User Created POIs", UCPOI_CheckBox.isSelected());
